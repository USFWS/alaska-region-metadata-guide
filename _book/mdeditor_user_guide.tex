...
\addcontentsline{toc}{section}{Metadata and mdEditor}
...
\addcontentsline{toc}{section}{Who Should Use this Manual}
...
\addcontentsline{toc}{chapter}{Projects, Products, and Contacts}
...
\addcontentsline{toc}{section}{Products}
...
\addcontentsline{toc}{section}{Relationships}
...
\addcontentsline{toc}{section}{From Scratch}
...
\addcontentsline{toc}{subsection}{Step 1: Gather information needed for your metadata entries.}
...
\addcontentsline{toc}{subsection}{Step 2: Open mdEditor.}
...
\addcontentsline{toc}{subsection}{Step 3: Set the correct default \protect\hyperlink{settings}{Settings}.}
...
\addcontentsline{toc}{subsection}{Step 4: Upload or Create \protect\hyperlink{contact-entry-guidance}{Contacts}.}
...
\addcontentsline{toc}{subsection}{Step 5: Upload \protect\hyperlink{dictionary-entry-guidance}{Data Dictionaries}.}
...
\addcontentsline{toc}{subsection}{Step 6: Create \protect\hyperlink{project-entry-guidance}{Projects}.}
...
\addcontentsline{toc}{subsection}{Step 7: Create \protect\hyperlink{product-entry-guidance}{Products}.}
...
\addcontentsline{toc}{subsection}{Step 8: For applicable Products, create \protect\hyperlink{dictionary-entry-guidance}{Data Dictionaries}.}
...
\addcontentsline{toc}{subsection}{Step 9: Complete metadata.}
...
\addcontentsline{toc}{subsection}{Step 10: Create desired Associations between Projects and/or Products.}
...
\addcontentsline{toc}{subsection}{Step 11: Publish your records to ScienceBase.}
...
\addcontentsline{toc}{subsection}{Step 12: \protect\hyperlink{export}{Export} your records and contacts for backup, transfer, or sharing.}
...
\addcontentsline{toc}{section}{Editing and Re-Export}
...
\addcontentsline{toc}{subsection}{Step 3: \protect\hyperlink{import}{Import} mdEditor file.}
...
\addcontentsline{toc}{subsection}{Step 4: Check the \protect\hyperlink{settings}{Settings}.}
...
\addcontentsline{toc}{subsection}{Step 5: Update \protect\hyperlink{contact-entry-guidance}{Contacts}.}
...
\addcontentsline{toc}{subsection}{Step 6: Update \protect\hyperlink{project-entry-guidance}{Projects}.}
...
\addcontentsline{toc}{subsection}{Step 7: Update \protect\hyperlink{product-entry-guidance}{Products}.}
...
\addcontentsline{toc}{subsection}{Step 8: For applicable Products, create, import, or update \protect\hyperlink{dictionary-entry-guidance}{Data Dictionaries}.}
...
\addcontentsline{toc}{subsection}{Step 9: Check Associations between Projects and/or Products.}
...
\addcontentsline{toc}{subsection}{Step 10: Publish your records to ScienceBase.}
...
\addcontentsline{toc}{subsection}{Step 11: \protect\hyperlink{export}{Export} your records and contacts for backup, transfer, or sharing.}
...
\addcontentsline{toc}{chapter}{File Management}
...
\addcontentsline{toc}{section}{How mdEditor Stores Information}
...
\addcontentsline{toc}{section}{mdEditor File Format}
...
\addcontentsline{toc}{section}{Import}
...
\addcontentsline{toc}{subsection}{General Import Settings}

\hypertarget{replace-vs.-merge}{%
\subsubsection*{Replace vs.~Merge}\label{replace-vs.-merge}}
\addcontentsline{toc}{subsubsection}{Replace vs.~Merge}
...
\addcontentsline{toc}{subsection}{Import Screen}
...
\addcontentsline{toc}{section}{Export}
...
\addcontentsline{toc}{subsection}{Using Export to Backup Records}
...
\addcontentsline{toc}{subsubsection}{mdEditor files vs.~mdJSON files}
...
\addcontentsline{toc}{subsection}{Export Options}
...
\addcontentsline{toc}{section}{Copy Records}
...
\addcontentsline{toc}{chapter}{Settings}
...
\addcontentsline{toc}{section}{General Settings}
...
\addcontentsline{toc}{section}{ScienceBase Import Settings}
...
\addcontentsline{toc}{section}{Publishing Settings}

{[}Under development{]}

\hypertarget{contact-entry-guidance}{%
\chapter*{Contact Entry Guidance}\label{contact-entry-guidance}}
\addcontentsline{toc}{chapter}{Contact Entry Guidance}
...
\addcontentsline{toc}{section}{Individual Contacts}
...
\addcontentsline{toc}{section}{Organization Contacts}
...
\addcontentsline{toc}{chapter}{Dictionary Entry Guidance}
...
\addcontentsline{toc}{section}{Creating a New Data Dictionary}
...
\addcontentsline{toc}{section}{Main Tab}
...
\addcontentsline{toc}{subsection}{Responsible Party (Required)}
...
\addcontentsline{toc}{section}{Citation Tab}
...
\addcontentsline{toc}{subsection}{Dates (Best Practice)}
...
\addcontentsline{toc}{subsection}{Responsible Parties (Required)}
...
\addcontentsline{toc}{section}{Entities Tab}
...
\addcontentsline{toc}{subsection}{Entity Information}
...
\addcontentsline{toc}{section}{Domain Tab}
...
\addcontentsline{toc}{chapter}{Project Entry Guidance}
...
\addcontentsline{toc}{subsection}{Select the lccProject Profile:}
...
\addcontentsline{toc}{subsection}{Make sure your \protect\hyperlink{contact_entry_guidance}{contacts} are loaded into mdEditor:}
...
\addcontentsline{toc}{section}{Edit a Project}
...
\addcontentsline{toc}{section}{Required and Best Practice Fields for Projects}

\hypertarget{main-tab-1}{%
\subsection*{Main Tab}\label{main-tab-1}}
\addcontentsline{toc}{subsection}{Main Tab}
...
\addcontentsline{toc}{subsection}{Metadata Tab}
...
\addcontentsline{toc}{subsection}{Keywords Tab}
...
\addcontentsline{toc}{subsection}{Extent Tab}
...
\addcontentsline{toc}{subsection}{Taxonomy Tab}
...
\addcontentsline{toc}{subsection}{Basic Information}

\hypertarget{record-id}{%
\subsubsection*{Record ID}\label{record-id}}
\addcontentsline{toc}{subsubsection}{Record ID}
...
\addcontentsline{toc}{subsubsection}{Title (Required)}
...
\addcontentsline{toc}{subsubsection}{Status (Required)}
...
\addcontentsline{toc}{subsubsection}{Default Locale}
...
\addcontentsline{toc}{subsubsection}{Resource Types (Required)}
...
\addcontentsline{toc}{subsubsection}{Points of Contact}
...
\addcontentsline{toc}{paragraph}{Contacts}
...
\addcontentsline{toc}{subsubsection}{Citation Required Fields}
...
\addcontentsline{toc}{subsubsection}{Abstract (Required)}
...
\addcontentsline{toc}{subsubsection}{Short Abstract (Optional)}
...
\addcontentsline{toc}{subsection}{Time Period}
...
\addcontentsline{toc}{subsubsection}{Dates (Required)}
...
\hypertarget{metadata-tab-project-metadata}{%
\section*{Metadata Tab \{\#project-metadata\}}\label{metadata-tab-project-metadata}}
\addcontentsline{toc}{section}{Metadata Tab \{\#project-metadata\}}
...
\addcontentsline{toc}{subsubsection}{Metadata Status (Best Practice)}
...
\addcontentsline{toc}{subsubsection}{Dates (Best Practice)}
...
\addcontentsline{toc}{subsection}{Metadata Contacts}
...
\addcontentsline{toc}{subsection}{Metadata Identifier}
...
\addcontentsline{toc}{subsection}{Parent Metadata}

{[}Under development{]}

\hypertarget{metadata-repositories}{%
\subsection*{Metadata Repositories}\label{metadata-repositories}}
\addcontentsline{toc}{subsection}{Metadata Repositories}
...
\addcontentsline{toc}{section}{Keyword Tab}
...
\addcontentsline{toc}{subsection}{Add Keywords to your Project}
...
\addcontentsline{toc}{subsection}{ISO Topic Category Thesaurus (Required)}
...
\addcontentsline{toc}{subsection}{GCMD Keywords Thesaurus (Best Practice)}
...
\addcontentsline{toc}{subsection}{Custom Thesaurus}
...
\addcontentsline{toc}{subsection}{Keywords and ScienceBase}
...
\addcontentsline{toc}{section}{Extent Tab}
...
\addcontentsline{toc}{subsection}{Creating Extents}
...
\addcontentsline{toc}{subsubsection}{Option 1: Import Spatial Features}
...
\addcontentsline{toc}{subsubsection}{Option 2: Draw Spatial Features}
...
\addcontentsline{toc}{subsubsection}{Option 3: Draw Bounding Box}
...
\addcontentsline{toc}{subsection}{Saving and Exporting Extents}
...
\addcontentsline{toc}{section}{Taxonomy Tab}
...
\addcontentsline{toc}{subsection}{Taxonomy}
...
\addcontentsline{toc}{subsubsection}{Add Taxonomic System}
...
\addcontentsline{toc}{subsection}{When Taxonomy is Needed}
...
\addcontentsline{toc}{subsection}{Reporting Issues}
...
\addcontentsline{toc}{section}{Associated Tab}
...
\addcontentsline{toc}{subsection}{Create Associations}
...
\addcontentsline{toc}{subsubsection}{Step-by-Step: Creating an Association in a Project Record}
...
\addcontentsline{toc}{chapter}{Product Entry Guidance}
...
\addcontentsline{toc}{subsection}{Select the lccProduct Profile:}
...
\addcontentsline{toc}{subsection}{Make sure your \protect\hyperlink{contact-entry_guidance}{contacts} are loaded into mdEditor:}
...
\addcontentsline{toc}{section}{Edit a Product}
...
\addcontentsline{toc}{section}{Required Fields for Products}
...
\addcontentsline{toc}{subsection}{Distribution Tab}
...
\addcontentsline{toc}{subsubsection}{Record ID (Required)}
...
\addcontentsline{toc}{subsection}{Default Locale}
...
\addcontentsline{toc}{subsection}{Resource Types (Required)}
...
\addcontentsline{toc}{subsection}{Points of Contact (Required)}
...
\addcontentsline{toc}{paragraph}{Responsible Parties (Required)}
...
\addcontentsline{toc}{paragraph}{Online Resource (Required, if available)}
...
\addcontentsline{toc}{section}{Metadata Tab}
...
\addcontentsline{toc}{subsection}{Add Keywords to your Product Record}
...
\addcontentsline{toc}{section}{Lineage Tab}
...
\addcontentsline{toc}{subsection}{Process Step}
...
\addcontentsline{toc}{section}{Distribution Tab}
...
\addcontentsline{toc}{subsection}{Distributor}
...
\addcontentsline{toc}{subsubsection}{Contacts and Role (Required)}
...
\addcontentsline{toc}{subsection}{Transfer Options (Required)}
...
\addcontentsline{toc}{subsection}{Example Distributor}
...
\addcontentsline{toc}{section}{Constraints Tab}
...
\addcontentsline{toc}{subsection}{Use Limitation}
...
\addcontentsline{toc}{subsection}{Legal}
...
\addcontentsline{toc}{subsection}{Security Constraints}
...
\addcontentsline{toc}{section}{Dictionaries Tab}
...
\addcontentsline{toc}{subsubsection}{Step-by-Step: Creating an Association in a Product Record}
...
\addcontentsline{toc}{chapter}{Help}
...
\addcontentsline{toc}{section}{HTML}
...
\addcontentsline{toc}{section}{ISO}
...
\addcontentsline{toc}{subsection}{ISO 19110}
...
\addcontentsline{toc}{subsection}{ISO 19115-1}
...
\addcontentsline{toc}{subsection}{ISO 19115-2}
...
\addcontentsline{toc}{section}{JSON}
...
\addcontentsline{toc}{section}{localStorage Cache}
...
\addcontentsline{toc}{section}{mdEditor}
...
\addcontentsline{toc}{section}{mdEditor File}
...
\addcontentsline{toc}{section}{mdJSON}
...
\addcontentsline{toc}{section}{mdJSON File}
...
\addcontentsline{toc}{section}{mdTranslator}
...
\addcontentsline{toc}{section}{ScienceBase}
...
\addcontentsline{toc}{section}{URI}
